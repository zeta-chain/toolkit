...
export const GITHUB_REQUEST_TOKEN_URL =
  "https://github.com/login/oauth/access_token";
export const GITHUB_WHOAMI_URL = "https://api.github.com/user";
export const ACCESS_TOKEN_FILE_PATH = "~/.zetachain/faucet_access_token.json";
