...
export interface ZetaSetupInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "setupZetaChain",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "wrapGatewayZEVM",
    values?: undefined
  ): string;
...
export interface ZetaSetup extends BaseContract {
  connect(runner?: ContractRunner | null): ZetaSetup;
  waitForDeployment(): Promise<this>;

  interface: ZetaSetupInterface;
  ...
  setupZetaChain: TypedContractMethod<[], [void], "nonpayable">;
  ...
  wrapGatewayZEVM: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "setupZetaChain"
  ...
  getFunction(
    nameOrSignature: "wrapGatewayZEVM"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
