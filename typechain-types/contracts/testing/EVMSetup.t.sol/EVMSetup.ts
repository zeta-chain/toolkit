...
export interface EVMSetupInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "chainIdETH"
  ...
  encodeFunctionData(
    functionFragment: "nodeLogicMockAddr",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "setupEVMChain",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "wrapGatewayEVM",
    values: [BigNumberish]
  ): string;
...
export interface EVMSetup extends BaseContract {
  connect(runner?: ContractRunner | null): EVMSetup;
  waitForDeployment(): Promise<this>;

  interface: EVMSetupInterface;
  ...
  custody: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  nodeLogicMockAddr: TypedContractMethod<[], [string], "view">;

  setupEVMChain: TypedContractMethod<
    [chainId: BigNumberish],
    [void],
    "nonpayable"
  >;

  systemContract: TypedContractMethod<[], [string], "view">;
  ...
  wrapGatewayEVM: TypedContractMethod<[arg0: BigNumberish], [string], "view">;

  wzeta: TypedContractMethod<[], [string], "view">;

  zetaConnector: TypedContractMethod<[arg0: BigNumberish], [string], "view">;

  zetaToken: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "nodeLogicMockAddr"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "setupEVMChain"
  ): TypedContractMethod<[chainId: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "systemContract"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "wrapGatewayEVM"
  ): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  getFunction(
