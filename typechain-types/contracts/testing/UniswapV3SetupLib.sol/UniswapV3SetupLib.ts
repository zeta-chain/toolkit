...
export interface UniswapV3SetupLibInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface UniswapV3SetupLib extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV3SetupLib;
  waitForDeployment(): Promise<this>;

  interface: UniswapV3SetupLibInterface;
