...
export interface UniswapV2SetupLibInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface UniswapV2SetupLib extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV2SetupLib;
  waitForDeployment(): Promise<this>;

  interface: UniswapV2SetupLibInterface;
