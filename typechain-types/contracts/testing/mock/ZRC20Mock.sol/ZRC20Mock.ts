...
export interface ZRC20MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CHAIN_ID"
      | "COIN_TYPE"
...
export interface ZRC20Mock extends BaseContract {
  connect(runner?: ContractRunner | null): ZRC20Mock;
  waitForDeployment(): Promise<this>;

  interface: ZRC20MockInterface;
