...
export interface IZRC20MockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "GAS_LIMIT"
      | "PROTOCOL_FLAT_FEE"
...
export interface IZRC20Mock extends BaseContract {
  connect(runner?: ContractRunner | null): IZRC20Mock;
  waitForDeployment(): Promise<this>;

  interface: IZRC20MockInterface;
