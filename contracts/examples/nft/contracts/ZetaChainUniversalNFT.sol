...
import {UniversalNFTCore as ZetaChainUniversalNFTCore} from "@zetachain/standard-contracts/contracts/nft/contracts/zetachain/UniversalNFTCore.sol";
...
contract ZetaChainUniversalNFT is
    ...
    ZetaChainUniversalNFTCore // Custom core for additional logic
{
    ...
    function tokenURI(
        ...
        override(
            ...
            ZetaChainUniversalNFTCore // Include UniversalNFTCore for URI overrides
        )
    ...
    function supportsInterface(
        ...
        override(
            ...
            ERC721EnumerableUpgradeable,
            ERC721URIStorageUpgradeable,
            ZetaChainUniversalNFTCore // Include UniversalNFTCore for interface overrides
        )
        returns (bool)
    {
