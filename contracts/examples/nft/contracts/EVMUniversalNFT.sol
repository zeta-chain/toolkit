...
import {UniversalNFTCore as EVMUniversalNFTCore} from "@zetachain/standard-contracts/contracts/nft/contracts/evm/UniversalNFTCore.sol";
...
contract EVMUniversalNFT is
    ...
    UUPSUpgradeable,
    EVMUniversalNFTCore // Add UniversalNFTCore for universal features
{
    ...
    function tokenURI(
        ...
        override(
            ERC721Upgradeable,
            ERC721URIStorageUpgradeable,
            EVMUniversalNFTCore // Include UniversalNFTCore for URI overrides
        )
    ...
    function supportsInterface(
        ...
        override(
            ...
            ERC721EnumerableUpgradeable,
            ERC721URIStorageUpgradeable,
            EVMUniversalNFTCore // Include UniversalNFTCore for interface overrides
        )
        returns (bool)
    {
